...
public sealed partial class CrewPickerControl : PickerControl
{
    ...
    public Action<NetEntity>? OnStationPinged;
    ...
    public CrewPickerControl()
    {
        ...
        PingThisShipButton.OnPressed += _ => PingThisShipButtonOnPressed();
        PingMessageEdit.OnTextChanged += _ =>
        {
            _pingMessage = PingMessageEdit.Text;
        };
    ...
    public override void UpdateUi(IReadOnlyDictionary<NetEntity, StationJobInformation> obj)
    {
        ...
        if (_lastSelectedStation != null && obj.TryGetValue(_lastSelectedStation.StationEntity, out var stationInfo))
        {
            ...
            if (stationEntity != default)
            {
                var ev = new CanPingStationEvent(stationEntity, false);
                _entityManager.EventBus.RaiseLocalEvent(stationEntity, ev);
                PingThisShipButton.Visible = ev.CanPingByGhosts;
            }
        }
    ...
    private void PingThisShipButtonOnPressed()
    {
